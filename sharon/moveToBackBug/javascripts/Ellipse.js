...
//		this.label=this.id;
	...
	p.getCenter=function(obj){
		...
		return {x:this.ellipseShape.getTransformedBoundingBox()[0].x+(this.getBBox().width)/4
					, y:this.ellipseShape.getTransformedBoundingBox()[0].y+(this.getBBox().height)/4};
	};
	...
	p.serialize=function(){
		...
		return '<g '+this.writeCommonAttrs()+'>'
			...
			+ '</g>'*/
			+ '<ellipse style="stroke:'+s.color+';stroke-weight:1;fill:none;" '
			+ 'x="' + this.start.x + '" '
