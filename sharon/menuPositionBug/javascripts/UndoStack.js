dojo.provide("dojox.diagram.UndoStack");
...
(function(){
	...
	dojo.declare("dojox.diagram.UndoStack",null,{
		//summary:
		//		the undo/redo stack, orinigal file from dojox.sketch
		...
		apply: function(state, from, to){
			...
			if(fromText.length==0){
				...
				var a=this.figure._loadShape(o);
		...
		//	stack methods.
		add: function(/*String*/cmd, /*ta.ShapeBase?*/ann, /*String?*/before){
			var id=ann?ann.id:'';
...
//					fullText:fullText,
			...
			//console.log('dojox.diagram history add',state);
			this._steps.push(state);
			//debugger;
			/*for(var i=0; i<this._steps.length; i++){
			console.log("_steps, before:"+this._steps[i].before.shapeId+",after:"+this._steps[i].after.shapeId);
			}
			console.log("another operation added.");*/
			this._undoedSteps = [];
		},
		destroy: function(){},
		undo: function(){
