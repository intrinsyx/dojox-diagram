...
//	Summary:
// 	toolbar for the shapes, selection mode, slider buttons
...
dojo.declare("dojox.diagram.Toolbar", dijit.Toolbar, {
	...
	postCreate: function(){
		...
		//after each drawing, go back to selection mode.
		this.connect(this.figure,'_mu','reset');
		if(!this.plugins){
			this.plugins=['Slider','Select','Rectangle','RoundRect','Ellipse'];
		}
		this._plugins=[];
